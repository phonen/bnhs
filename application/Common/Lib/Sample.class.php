...
class Sample {
    ...
    public function get_token(){
       $url = 'https://openapi.baidu.com/oauth/2.0/token?grant_type=client_credentials&client_id=xBP9pBqGEH1sEIfM4GPdh7fd&client_secret=gRzt6lf6EyyOHHHnFLSwuFN4qzodd1EA';
        $res = curl_data($url);
